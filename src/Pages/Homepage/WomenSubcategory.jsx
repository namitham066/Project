  ...
  useEffect(() => {
    const fetchSubcategoryData = async () => {
      try {
        ...
        const womenCategory = jsonData.find((item) => item.category === "Women");
          console.log(womenCategory,"Womennnn");
          
        if (womenCategory) {
          const foundSubcategories = womenCategory.subcategories.filter(
